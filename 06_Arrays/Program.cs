...
namespace _06_Arrays
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //int[] numbers = { 45, 85, 52, 41, 86, 10, 22, 35 };
            //Array.Sort(numbers);//küçükten büyüğe sıralar.
            //Array.Reverse(numbers);//short methodundan sonra büyükten küçüğe sıralar.
            //for (int i = 0; i < numbers.Length; i++)
            //{
            //    Console.WriteLine(numbers[i]);
            //}
            ...
            //ÖRN: Dizideki tüm elemanların toplamını gösteren program.
            ...
            //Dizi içindeki tek ve çift sayıları ayrı ayrı listeleyen program.
